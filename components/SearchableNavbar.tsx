...
const searchData = [
  ...
  { title: 'Автоматизация', description: 'Автоматические процессы разработки и р��звертывания для ускорения работы', url: '/', section: 'Возможности' },
  ...
  { title: 'И�� интеграция', description: 'Интеграция искусственного интеллекта в ваши проекты', url: '/', section: 'Функции' },
