...
const searchData = [
  ...
  { title: 'ИИ дизайн', description: 'Автоматическое создан��е современных интерфейсов с помощью машинного обучения', url: '/', section: 'Возможности' },
  ...
  { title: 'Max план', description: 'Премиум решение - максимум возможностей для к��упного бизнеса', url: '/', section: 'Тарифы' },
