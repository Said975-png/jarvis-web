...
const searchData = [
  ...
  { title: 'Процес�� договора', description: 'Подробная информация о процессе работы с нами', url: '/', section: 'Услуги' },
  { title: 'ДЖАРВИС ИИ ассистент', description: 'Умный помощник для разработки, который п��нимает контекст', url: '/', section: 'Возможности' },
  ...
  { title: 'Max план', description: 'Премиум решение - максимум возможностей для ��рупного бизнеса', url: '/', section: 'Тарифы' },
  { title: 'Современный дизайн', description: 'Соз��ание красивых и функциональных интерфейсов', url: '/', section: 'Функции' },
  { title: 'Высокая ��роизводительность', description: 'Оптимизация скорости и производительности веб-сайтов', url: '/', section: 'Функции' },
