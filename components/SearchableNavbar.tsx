...
const searchData = [
  ...
  { title: 'Max план', description: 'Премиум решение - ��аксимум возможностей для крупного бизнеса', url: '/', section: 'Тарифы' },
  ...
  { title: 'Корзина', description: 'Просмотр добавленны�� товаров и оформление заказа', url: '/', section: 'Покупки' },
