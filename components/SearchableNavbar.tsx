...
// Данные для поиска
const searchData = [
  { title: 'Главная', description: 'Гла��ная страница с общей информацией о компании', url: '/', section: 'Страницы' },
  ...
  { title: 'Автоматизация', description: 'Автоматические процессы разработки и развертывания для ускорения работы', url: '/', section: 'Возможност��' },
