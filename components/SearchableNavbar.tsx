...
const searchData = [
  ...
  { title: 'ДЖАРВИС ИИ ассистент', description: 'Умный ��омощник для разработки, который понимает контекст', url: '/', section: 'Возможности' },
    ...
    <>
          ...
          <div className="nav-links-wrapper-chatgpt">
            ...
            <div className="theme-toggle-container-chatgpt">
              <button
                ...
                title="Функция смены темы нах��дится в разработке"
              >
                {isDarkTheme ? (
      ...
      {showCheckout && (
        <Checkout
          ...
          onSuccess={() => {
            alert('Заказ усп��шно оформлен! Вы можете отслеживать его статус в личном кабинете.')
          }}
        />
      )}
