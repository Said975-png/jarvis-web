            ...
            <div className="modal-body-chatgpt">
              ...
              <div className="process-step-chatgpt">
                ...
                <div className="step-content-chatgpt">
                  ...
                  <p>Предлагаем техническую поддержку проекта, обновления и добавление новых функций. Помогаем масштабировать ваш бизнес с помощью дополнительных И�� решений и интеграций.</p>
                </div>
              </div>
