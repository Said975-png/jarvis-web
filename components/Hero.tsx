            ...
            <div className="chat-interface-chatgpt">
              ...
              <div className="chat-messages-chatgpt">
                ...
                <div className="message-chatgpt ai-message-chatgpt">
                  ...
                  <div className="message-bubble-chatgpt">
                    Конечно! Вот компонент анимированной кнопки с hover эффектами и плавными переходами. Кнопка включает масштабирование, изменение цвета и тень при наведении.
                  </div>
                </div>
