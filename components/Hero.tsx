            ...
            <div className="modal-body-chatgpt">
              ...
              <div className="process-step-chatgpt">
                ...
                <div className="step-content-chatgpt">
                  ...
                  <p>Проводим полное тестирование функционала, проверяем адаптивность на всех устройствах, оптимизируем скорость заг��уз��и. Исправляем выявленные ошибки и до��абатываем детали по вашим пожеланиям.</p>
                </div>
              </div>
              ...
              <div className="process-step-chatgpt">
                ...
                <div className="step-content-chatgpt">
                  ...
                  <p>Предлагаем техническую поддержку проекта, обновления и добавление новых функций. Помогаем масштабировать ваш бизнес с помощью дополн��тельных ИИ решений и интеграций.</p>
                </div>
              </div>
