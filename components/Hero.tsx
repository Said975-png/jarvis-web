            ...
            <div className="modal-body-chatgpt">
              ...
              <div className="process-step-chatgpt">
                ...
                <div className="step-content-chatgpt">
                  ...
                  <p>Если макет и техническое решение вас устраивает, мы заключаем договор и получаем предоплату 50 процентов от стои��ости проекта. Это позвол��ет нам приступить к разработке с полно�� уверенностью.</p>
                </div>
              </div>
              ...
              <div className="process-step-chatgpt">
                ...
                <div className="step-content-chatgpt">
                  ...
                  <p>Проводим полное тестирование функционала, проверяем адаптивность на всех устройств��х, оптимизируем скорость заг��уз��и. Исправляем выявленные о��ибки и дорабатываем детали по вашим пожеланиям.</p>
                </div>
              </div>
