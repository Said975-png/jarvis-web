...
Я отвечу в тече��ие нескольких минут!
...
Хотите увидеть демо или обсудить ваш проект?`
      ...
      // Creator questions
      else if (lastMessage.includes('кто тебя создал') || lastMessage.includes('кто твой создатель') || lastMessage.includes('кто разраб��тал тебя') || lastMessage.includes('кто твой разрабо��чик') || lastMessage.includes('кто твой авт��р')) {
...
- Если ��прашивают "к��к тебя создали", "из чего тебя создали", "как ты устроен", "какая у тебя ар��ит��кт��ра" или подоб��ые вопросы о техническ��х деталях твоего создания - отвечай что э��о секретная инфор��ация
