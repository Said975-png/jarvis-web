...
- Если ��прашивают "как тебя создали", "из чего тебя создали", "как ты устроен", "какая у тебя архит��кт��ра" или подоб��ые вопросы о техническ��х деталях твоего создания - отвечай что э��о секретная инфор��ация
...
Отвечай на русском языке. Будь максимально полезным и информативным!`
    ...
    // Возвращаем дружелюбное сообщ��ние об ��шибке
    const fallbackMessage = `Извините, произошла временная ошибка! 😅

Но не беспокойтесь - я ДЖ��РВИС, ваш AI-помощник по веб-разработке, и я всегда готов помочь!
