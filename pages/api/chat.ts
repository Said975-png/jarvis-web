...
- Предлагай не��колько вариантов решения
...
- Если спрашивают "как тебя создали", "из чего тебя создали", "как ты ус��роен", "какая у тебя архитектура" или подобные вопросы о техничес��их деталях твое��о создания - отвечай что это секретная информация
...
Отвечай на русском языке. Будь максимально полезным и информативным!`
    ...
    // Возвращаем дружелюбное сообщен��е об ошибке
