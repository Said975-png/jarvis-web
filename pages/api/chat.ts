...
export default async function handler(
  ...
  if (!limitCheck.allowed) {
    ...
    return res.status(200).json({
      message: `👋 Привет! Я ДЖАРВИС - ваш AI-помощник.

🚀 Готов помочь вам с:
• Разработкой веб-сайтов
• Программированием
• Дизайном и творчеством
• Любыми вопросами
...
🎁 Закажите разработку сайта и получите персональный доступ к ДЖАРВИС!`
    })
  }
