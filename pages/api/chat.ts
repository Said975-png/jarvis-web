...
Я отвечу в течен��е нескольких минут!
...
Какой AI функционал вас и��тересует?`
      }
      // Portfolio/examples
...
💬 Задавайте любые вопросы прямо здесь!`
    ...
    const systemMessage: ChatMessage = {
      role: 'system',
      content: `Ты ДЖАРВИС - продвинутый AI-помощник и эксперт по веб-разработке. Ты обладаешь глубокими знаниями и всегда даешь подробны��, практичные и умные ответы.
...
- Ссылайся на актуальные техн��логии
...
- Если ��прашивают "к��к тебя создали", "из чего тебя создали", "как ты устроен", "какая у тебя ар����ит��кт���ра" ��ли по��об���ые вопросы о техническ��х дет��лях твоего создания - отвечай что э��о секретная инфор��ация
...
Отвечай на русском языке. Будь максимально полезным и информативным!`
    ...
    // Добавляем информацию об оставшихся ��апросах к AI ответу
    const remainingInfo = limitCheck.remaining > 0
      ? `\n\n📊 Осталось бесплатных вопросов: ${limitCheck.remaining}`
      : `\n\n⚠️ Это ваш последний бесплатный вопрос! Следующий будет платным.`
